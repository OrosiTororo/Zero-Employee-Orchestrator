...
_WEB_AI_CATALOG: dict[WebAIService, dict] = {
    ...
    WebAIService.GEMINI: {
        ...
        "free_tier": True,
        "free_model": "Gemini Flash",
        "subscription_model": "Gemini Pro",
    ...
    WebAIService.CLAUDE: {
        ...
        "url": "https://claude.ai",
        "free_tier": True,
        "free_model": "Claude Sonnet",
        "subscription_model": "Claude Opus",
    ...
    WebAIService.COPILOT: {
        ...
        "free_tier": True,
        "free_model": "GPT (latest)",
        "subscription_model": "GPT + DALL-E",
