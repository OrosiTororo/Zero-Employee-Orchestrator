...
| OS | どのファイルをダウンロード？ | 説明 |
|----|---------------------------|------|
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_ja-JP.msi` | 日本語 Windows インストーラー。ダブルクリックで実行 |
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_en-US.msi` | English Windows installer |
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_zh-CN.msi` | 中文 Windows 安装程序 |
| **macOS** | `Zero-Employee-Orchestrator_x.x.x_universal.dmg` | macOS 用。開いて Applications にドラッグ |
| **Linux** | `Zero-Employee-Orchestrator_x.x.x_amd64.AppImage` | そのまま実行可能（インストール不要） |
| **Linux** | `Zero-Employee-Orchestrator_x.x.x_amd64.deb` | Debian/Ubuntu 用パッケージ |

> **注意**: `x.x.x` の部分は実際のバージョン番号に読み替えてください。最新版は [こちら](https://github.com/TroroOrosi/Zero-Employee-Orchestrator/releases/latest) からダウンロードできます。
...
| OS | Which file to download? | Description |
|----|------------------------|-------------|
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_en-US.msi` | English Windows installer. Double-click to run |
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_ja-JP.msi` | Japanese Windows installer |
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_zh-CN.msi` | Chinese Windows installer |
| **macOS** | `Zero-Employee-Orchestrator_x.x.x_universal.dmg` | For macOS. Open and drag to Applications |
| **Linux** | `Zero-Employee-Orchestrator_x.x.x_amd64.AppImage` | Runs directly (no install needed) |
| **Linux** | `Zero-Employee-Orchestrator_x.x.x_amd64.deb` | Debian/Ubuntu package |

> **Note**: Replace `x.x.x` with the actual version number. Download the latest from [here](https://github.com/TroroOrosi/Zero-Employee-Orchestrator/releases/latest).
...
| 操作系统 | 下载哪个文件？ | 说明 |
|---------|--------------|------|
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_zh-CN.msi` | 中文 Windows 安装程序。双击运行 |
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_en-US.msi` | English Windows installer |
| **Windows** | `Zero-Employee-Orchestrator_x.x.x_x64_ja-JP.msi` | 日本語 Windows インストーラー |
| **macOS** | `Zero-Employee-Orchestrator_x.x.x_universal.dmg` | macOS 用。打开后拖到 Applications |
| **Linux** | `Zero-Employee-Orchestrator_x.x.x_amd64.AppImage` | 直接运行（无需安装） |
| **Linux** | `Zero-Employee-Orchestrator_x.x.x_amd64.deb` | Debian/Ubuntu 软件包 |

> **注意**：`x.x.x` 请替换为实际版本号。从[这里](https://github.com/TroroOrosi/Zero-Employee-Orchestrator/releases/latest)下载最新版本。
