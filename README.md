...
> **まとめ**: Assets には 8 個のファイルがあります。OS に合った 1 つをダウンロードしてください。
...
> **Summary**: There are 8 files in Assets. Download the one that matches your OS.
...
> **总结**：Assets 中有 8 个文件，请下载与您操作系统匹配的 1 个。
