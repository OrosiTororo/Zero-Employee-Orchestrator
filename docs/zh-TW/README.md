...
| **[Docker](#-快速開始-cli)** | 自架 / 生產環境 | 5 分鐘 | 否（訂閱模式或 Ollama） |

**系統需求：** Python 3.12+（CLI）、Node.js 22+（前端開發）、記憶體 4 GB 以上。Ollama 本地模型需要 8 GB 以上記憶體。
...
| **應用程式連接器中心** | 35+ 應用程式（Obsidian、Notion、Google Workspace、Microsoft 365 等） |
| **AI 工具整合** | 19 個類別、45+ 外部工具 |
