> English | [日本語](ja-JP/SECURITY.md) | [中文](zh/SECURITY.md)
...
| `GOOGLE_LOGIN_CLIENT_ID` / `GOOGLE_LOGIN_CLIENT_SECRET` | `apps/api/.env` (optional Web/Tauri sign-in) | [Google Cloud Console](https://console.cloud.google.com/) |
| `GOOGLE_CLIENT_ID` / `GOOGLE_CLIENT_SECRET` | `apps/api/.env` (optional Workspace connectors) | Use a separate connector-specific OAuth client |
