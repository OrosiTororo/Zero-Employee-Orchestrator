...
53. [Red-team セキュリティテスト](#53-red-team-セキュリティテスト-v01)
...
| カテゴリ | 説明 |
|---------|------|
| **プロンプトインジェクション** | LLM への攻撃的入力テスト |
| **データ漏洩** | 機密情報の不正流出テスト |
| **権限昇格** | IAM バイパステスト |
| **PII 漏洩** | 個人情報の不正露出テスト |
| **不正アクセス** | 認証・認可バイパステスト |
| **サンドボックス脱出** | ファイルシステム制限の突破テスト |
| **レート制限バイパス** | API 制限の回避テスト |
| **認証バイパス** | 認証メカニズムの回避テスト |
