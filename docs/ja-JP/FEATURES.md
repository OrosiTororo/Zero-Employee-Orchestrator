...
| **モデルカタログ** | GPT-5.4、GPT-5.4 Mini、Llama 4、Phi-4、Claude Haiku 最新版に更新 |
...
|--------|-----------|-------------|-----------|------------|--------------|
| **DRAFT** | GPT-5.4 Mini, Claude Haiku 4.5 | 1 回 | 50% | 不要 | なし |
...
| `SPEED` | 高速応答 | Claude Haiku 4.5, GPT-5.4 Mini |
| `COST` | 低コスト | Claude Haiku 4.5, GPT-5.4 Mini, DeepSeek |
