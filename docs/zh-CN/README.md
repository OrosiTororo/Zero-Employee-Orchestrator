...
| **[Docker](#-快速开始-cli)** | 自托管 / 生产环境 | 5 分钟 | 否（订阅模式或 Ollama） |

**系统要求：** Python 3.12+（CLI）、Node.js 22+（前端开发）、内存 4 GB 以上。Ollama 本地模型需要 8 GB 以上内存。
