...
> 作成日: 2026-03-08  
> 参照優先順位: `docs/Zero-Employee Orchestrator.md` → `docs/dev/DESIGN.md` → instructions 系ファイル
...
| `docs/dev/instructions_section2_init.md` | 初期構築指示 | 開発基盤・初期リポジトリ整備 |
| `docs/dev/instructions_section3_backend.md` | バックエンド指示 | 認証、状態、Orchestrator、Judge など |
| `docs/dev/instructions_section4_frontend.md` | フロントエンド指示 | ダッシュボード、Interview、Plan、Execution UI |
| `docs/dev/instructions_section5_skills.md` | Skill 指示 | YouTube 等の代表 Skill 実装 |
| `docs/dev/instructions_section6_tauri.md` | デスクトップ統合指示 | Tauri 統合、ローカル実行 |
| `docs/dev/instructions_section7_test.md` | テスト指示 | 単体、結合、E2E、セキュリティ |
...
4. 自分が担当する `docs/dev/instructions_section*` ファイル
...
- `docs/dev/instructions_section2〜7` は、この新方針に対応済みの前提で扱う
