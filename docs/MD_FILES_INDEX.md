...
| 項目 | 内容 |
|------|------|
| **場所** | `/docs/DEVELOPER_SETUP.md` |
| **目的** | 開発者・管理者向けの手動セットアップガイド |
| **対象読者** | 開発者・システム管理者 |
| **主な内容** | API キー設定、OAuth2 設定、iPaaS Webhook 設定、DB 設定、Docker デプロイ、セキュリティ設定（本番環境）、クラウドプロバイダー設定、Heartbeat スケジューラ、レッドチームテスト |
...
| 項目 | 内容 |
|------|------|
| **場所** | `/docs/USER_SETUP.md` |
| **目的** | 利用ユーザー向けのセットアップガイド |
| **対象読者** | エンドユーザー |
| **主な内容** | ワークスペース隔離環境の説明、ローカル・クラウドアクセス許可設定、業務ごとの環境カスタマイズ、ファイルサンドボックス、データ保護設定、Ollama セットアップ、Chrome 拡張機能、Obsidian 連携 |
