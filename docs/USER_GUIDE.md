> English | [日本語](ja-JP/USER_GUIDE.md) | [中文](zh/USER_GUIDE.md)
...
|------|-------------|-----------------|
| `quality` | Highest quality models (Claude Opus, GPT, Gemini Pro) | Important deliverables |
| `speed` | Fast models (Claude Haiku, GPT Mini, Gemini Flash) | Simple tasks |
