...
| **[Docker](#-빠른-시작-cli)** | 셀프 호스트 / 프로덕션 | 5분 | 불필요 (구독 또는 Ollama) |

**시스템 요구사항:** Python 3.12+ (CLI), Node.js 22+ (프론트엔드 개발), RAM 4 GB 이상. Ollama 로컬 모델은 8 GB 이상의 RAM이 필요합니다.
...
| **앱 커넥터 허브** | 35+ 앱 (Obsidian, Notion, Google Workspace, Microsoft 365 등) |
| **AI 도구 통합** | 19개 카테고리, 45+ 외부 도구 |
