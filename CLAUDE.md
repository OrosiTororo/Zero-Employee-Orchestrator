...
**IMPORTANT: このファイルの情報が古い場合は、実際のコードを読んで更新すること。**
...
│   │   ├── api/routes/     # REST API エンドポイント (28 ルートモジュール)
│   │   ├── api/ws/         # WebSocket
│   │   ├── api/deps/       # 依存性注入
...
│   │   ├── integrations/   # Sentry・MCP・外部スキル・ブラウザアシスト・AI 調査
│   │   ├── audit/          # 監査ログ
│   │   └── tests/          # テスト
│   ├── alembic/            # DB マイグレーション
...
| Extension | システム連携・インフラ | mcp, oauth, notifications, obsidian |
